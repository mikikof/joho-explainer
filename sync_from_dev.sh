...
for f in sampling-theorem.html color-digitization.html image-resolution.html compression.html os-abstraction.html complement-subtraction.html logic-gates.html; do
  cp "$DEV/$f" "$ROOT/$f"
  echo "synced: $f"
done
