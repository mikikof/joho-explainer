...
for f in sampling-theorem.html color-digitization.html image-resolution.html compression.html os-abstraction.html complement-subtraction.html logic-gates.html instruction-execution.html loop-range.html array-index-trace/ binary-search/; do
  if [[ "$f" == */ ]]; then
    d="${f%/}"
